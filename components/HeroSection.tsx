  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* ── LEFT: Text content ── */}
        <div style={{ flex: "0 0 44%", paddingRight: "40px" }}>
          {/* Badge */}
          <motion.div
          ...
          <motion.h1
            ...
            style={{
              ...
              marginBottom: "28px", letterSpacing: "-0.035em",
              color: "white",
            }}
          >
            Building<br />
          ...
          <motion.p
            ...
            style={{
              ...
              lineHeight: 1.75, marginBottom: "44px", maxWidth: "460px", fontWeight: 400,
            }}
          >
          ...
          <motion.div
            ...
            style={{ display: "flex", gap: "16px", marginBottom: "60px", flexWrap: "wrap" }}
          >
            <a
              href="#projects"
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = "0 10px 32px rgba(0,242,255,0.4)";
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow = "0 6px 24px rgba(0,242,255,0.25)";
              }}
            >
